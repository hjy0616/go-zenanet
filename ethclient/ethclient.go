...
func (ec *Client) EstimateGasAtBlock(ctx context.Context, msg zenanet.CallMsg, blockNumber *big.Int) (uint64, error) {
	var hex hexutil.Uint64
...
func (ec *Client) EstimateGasAtBlockHash(ctx context.Context, msg zenanet.CallMsg, blockHash common.Hash) (uint64, error) {
	var hex hexutil.Uint64
